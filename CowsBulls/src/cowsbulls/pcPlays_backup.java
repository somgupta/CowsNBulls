...
public class pcPlays_backup {
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            FileInputStream dict1 = new FileInputStream("/home/som/Desktop/newdict.txt");
            ...
            */
            ...
            while(success)
            {
                ...
                if(pcow==2 && !prev.equals("") && pcow>cows)
                {
                    char[] pr = prev.toCharArray();
                    char[] pw = word.toCharArray();
                    if(bulls==0)
                    {
                        if(pr[0]==pw[0])
                        {
                            ...
                            {
                                char[] as=a.toCharArray();
                                if(pw[1]==pr[1] && pw[1]==as[1] &&pw[0]==as[0])
                                {
                                    if(setc.contains(a))
                                        setc.remove(a);
                                }
                                else if(pw[2]==pr[2] && pw[2]==as[2] &&pw[0]==as[0])
                                {
                                    if(setc.contains(a))
                                        setc.remove(a);
                                }
                                else if(pw[1]!=pw[0]&&(pw[1]==as[1] || pw[1]==as[2] || pw[1]==as[0]) ||
                                   pw[2]!=pw[0]&&(pw[2]==as[1] || pw[2]==as[2] || pw[2]==as[0]))
                                {
                                    if(setc.contains(a))
                                        setc.remove(a);
                                }
                        ...
                        else if(pr[2]==pw[2])
                        {
                            ...
                            {
                                char[] as=a.toCharArray();
                                if(pw[1]==pr[1] && pw[1]==as[1] &&pw[2]==as[2])
                                {
                                    if(setc.contains(a))
                                        setc.remove(a);
                                }
                                else if(pw[0]==pr[0] && pw[2]==as[2] &&pw[0]==as[0])
                                {
                                    if(setc.contains(a))
                                        setc.remove(a);
                                }
                                else if(pw[1]!=pw[2]&&(pw[1]==as[1] || pw[1]==as[2] || pw[1]==as[0]) ||
                                   pw[0]!=pw[2]&&(pw[0]==as[1] || pw[0]==as[2] || pw[0]==as[0]))
                                {
                                    if(setc.contains(a))
                                        setc.remove(a);
                                }
                        ...
                        else if(pr[1]==pw[1])
                        {
                            ...
                            {
                                char[] as=a.toCharArray();
                                if(pw[0]==pr[0] && pw[1]==as[1] &&pw[0]==as[0])
                                {
                                    if(setc.contains(a))
                                        setc.remove(a);
                                }
                                else if(pw[2]==pr[2] && pw[2]==as[2] &&pw[1]==as[1])
                                {
                                    if(setc.contains(a))
                                        setc.remove(a);
                                }
                                else if(pw[0]!=pw[1]&&(pw[0]==as[1] || pw[0]==as[2] || pw[0]==as[0]) ||
                                   pw[2]!=pw[1]&&(pw[2]==as[1] || pw[2]==as[2] || pw[2]==as[0]))
                                {
                                    if(setc.contains(a))
                                        setc.remove(a);
                                }
